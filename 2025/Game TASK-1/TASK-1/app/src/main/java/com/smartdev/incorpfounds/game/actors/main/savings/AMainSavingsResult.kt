package com.smartdev.incorpfounds.game.actors.main.savings

import com.badlogic.gdx.graphics.Color
import com.badlogic.gdx.scenes.scene2d.ui.Label
import com.badlogic.gdx.scenes.scene2d.ui.Label.LabelStyle
import com.smartdev.incorpfounds.game.actors.ABottomMenu
import com.smartdev.incorpfounds.game.actors.ALogo
import com.smartdev.incorpfounds.game.actors.ASavingGroup
import com.smartdev.incorpfounds.game.actors.button.AButton
import com.smartdev.incorpfounds.game.actors.button.AButtonText
import com.smartdev.incorpfounds.game.dataStore.DataSaving
import com.smartdev.incorpfounds.game.screens.CalculatorScreen
import com.smartdev.incorpfounds.game.screens.DashboardScreen
import com.smartdev.incorpfounds.game.screens.GlossaryScreen
...
import com.smartdev.incorpfounds.game.utils.actor.*
import com.smartdev.incorpfounds.game.utils.advanced.AdvancedMainGroup
import com.smartdev.incorpfounds.game.utils.font.FontParameter

class AMainSavingsResult(
    override val screen: SavingsResultScreen,
): AdvancedMainGroup() {
    ...
    private val dataSaving = gdxGame.ds_SavingData.flow.value.last()

    private val aLogo        = ALogo(screen)
    private val lblTitle     = Label("Result", ls102)
    private val btnSave      = AButtonText(screen, ls48, "Save", AButton.Type.Green)
    ...
    private val aSavingGroup = ASavingGroup(screen, dataSaving, lsB_84, lsB_60, lsM_54)
        ...
        btnDelete.apply {
            ...
            setOnClickListener {
                gdxGame.ds_SavingData.update {
                    ...
                    mList.remove(dataSaving)
                    mList
                }
                this@AMainSavingsResult.animDelay(0.1f) {
                    navTo(SavingsScreen::class.java.name)
                }
            }
        }
