package com.fond.buduchego.game.utils.advanced
...
import com.fond.buduchego.game.utils.font.FontGenerator
import com.fond.buduchego.game.utils.font.FontGenerator.Companion.FontPath
import com.fond.buduchego.util.cancelCoroutinesAll
...
abstract class AdvancedScreen(
    ...
    val fontGenerator_Bold     = FontGenerator(FontPath.SF_Bold)
    val fontGenerator_SemiBold = FontGenerator(FontPath.SF_SemiBold)
    val fontGenerator_Heavy    = FontGenerator(FontPath.SF_Heavy)
    val fontGenerator_Medium   = FontGenerator(FontPath.SF_Medium)
    val fontGenerator_Regular   = FontGenerator(FontPath.SF_Regular)
    ...
    override fun show() {
        log("show AdvancedScreen: ${this::class.simpleName}")
    ...
    override fun dispose() {
        ...
        disposeAll(
            stageBack, stageUI,
            drawerUtil,
            fontGenerator_Bold, fontGenerator_Heavy, fontGenerator_SemiBold,
            fontGenerator_Medium, fontGenerator_Regular,
        )
