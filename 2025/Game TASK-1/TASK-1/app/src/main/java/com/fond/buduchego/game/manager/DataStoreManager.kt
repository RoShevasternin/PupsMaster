...
object DataStoreManager: AbstractDataStore() {
    override val Context.dataStore: DataStore<Preferences> by preferencesDataStore(name = "GAME-STORE")

    object Saving: DataStoreElement<String>() {
        override val key = stringPreferencesKey("Saving")
    }

    object TestProgress: DataStoreElement<String>() {
        override val key = stringPreferencesKey("TestProgress")
    }
