package com.fond.buduchego.game.actors.main.test
...
import com.fond.buduchego.game.actors.AAnswer
...
import com.fond.buduchego.game.actors.label.ALabelAutoFont
...
import com.fond.buduchego.game.utils.actor.disable
import com.fond.buduchego.game.utils.actor.enable
import com.fond.buduchego.game.utils.actor.setOnClickListener
...
class AMainSelectedTest(
    ...
    private val btnNext     = AButtonText(screen, ls48_SB,"Следующий вопрос", AButton.Type.Green)
