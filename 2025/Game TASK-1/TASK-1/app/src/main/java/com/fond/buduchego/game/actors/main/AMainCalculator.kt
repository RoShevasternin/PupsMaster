...
import com.fond.buduchego.game.actors.*
...
class AMainCalculator(
    ...
    private val font102 = screen.fontGenerator_Bold.generateFont(parameter.setSize(75))
    ...
    private val lblTitle     = Label("Калькулятор депозитов", ls102)
    private val lblResult    = Label("Результат", ls102)
    ...
    private val btnCalcul    = AButtonText(screen, ls48, "Рассчитать", AButton.Type.Green)
