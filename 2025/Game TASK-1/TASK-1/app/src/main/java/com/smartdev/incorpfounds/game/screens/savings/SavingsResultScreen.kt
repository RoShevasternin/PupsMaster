...
import com.smartdev.incorpfounds.game.actors.main.savings.AMainSavingsResult
...
class SavingsResultScreen: AdvancedMainScreen() {

    override val aMain = AMainSavingsResult(this)
