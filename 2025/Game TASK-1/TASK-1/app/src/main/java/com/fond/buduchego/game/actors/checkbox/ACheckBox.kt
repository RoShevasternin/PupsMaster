package com.fond.buduchego.game.actors.checkbox
...
open class ACheckBox(
    ...
    fun getStyleByType(type: Type) = when(type) {
        Type.SimpleCompound -> ACheckBoxStyle(
            default = gdxGame.assetsAll.box_simple,
            checked = gdxGame.assetsAll.box_compound,
        )
    }
