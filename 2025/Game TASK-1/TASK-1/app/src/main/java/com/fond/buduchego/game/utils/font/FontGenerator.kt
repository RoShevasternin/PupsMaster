package com.fond.buduchego.game.utils.font
...
class FontGenerator(fontPath: FontPath): FreeTypeFontGenerator(Gdx.files.internal(fontPath.path)) {
    ...
    companion object {
        enum class FontPath(val path: String) {
            SF_Bold     ("font/sf_bold.ttf"),
            SF_SemiBold ("font/sf_semibold.ttf"),
            SF_Heavy    ("font/sf_heavy.ttf"),
            SF_Medium   ("font/sf_medium.ttf"),
            SF_Regular  ("font/sf_regular.ttf"),
        }
    }
