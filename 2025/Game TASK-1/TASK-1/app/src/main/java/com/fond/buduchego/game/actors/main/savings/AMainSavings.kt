...
import com.fond.buduchego.game.utils.TIME_ANIM_SCREEN
...
import com.fond.buduchego.game.utils.actor.setOnTouchListener
...
class AMainSavings(
    ...
    private val lblTitle     = Label("Экономия средств", ls102)
    private val btnCalculate = AButtonText(screen, ls48, "Расчет экономии средств", AButton.Type.Green)
    private val aBottomMenu  = ABottomMenu(screen, ABottomMenu.Type.Savings)
    private val lblAll       = Label("Вся экономия средств", ls102)
