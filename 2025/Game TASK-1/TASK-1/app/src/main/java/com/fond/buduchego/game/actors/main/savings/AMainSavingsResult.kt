package com.fond.buduchego.game.actors.main.savings
...
import com.fond.buduchego.game.actors.ASavingGroup
...
import com.fond.buduchego.game.utils.actor.*
...
class AMainSavingsResult(
    ...
    private val lblTitle     = Label("Результат", ls102)
    private val btnSave      = AButtonText(screen, ls48, "Сохранить", AButton.Type.Green)
